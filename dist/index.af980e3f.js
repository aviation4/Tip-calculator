...
})({"8LrJA":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "521e8e7caf980e3f";
...
},{}],"ka40h":[function(require,module,exports) {
var _functions0Js = require("./functions0.js");
...
},{"./functions0.js":"iBOAl","./functions.js":"bfprH","./variables.js":"abb56"}],"iBOAl":[function(require,module,exports) {
...
const calculateResults = ()=>{
    ...
    const resultTipNotRounded = (_variablesJs.inputsDOMArray[0].value * tipFactor - _variablesJs.inputsDOMArray[0].value) / _variablesJs.inputsDOMArray[2].value;
    _variablesJs.resultTip.innerHTML = Math.round(resultTipNotRounded * 100) / 100;
    _variablesJs.resultTotal.innerHTML = Math.round(_variablesJs.inputsDOMArray[0].value * tipFactor / _variablesJs.inputsDOMArray[2].value * 100) / 100;
    ...
    /* Add euro sign */ _variablesJs.resultTip.innerHTML = "€" + _variablesJs.resultTip.innerHTML;
    ...
    /* Add euro sign */ _variablesJs.resultTotal.innerHTML = "€" + _variablesJs.resultTotal.innerHTML;
};
const resetResults = ()=>{
    _variablesJs.resultTip.innerHTML = "$0";
    _variablesJs.resultTotal.innerHTML = "€0";
...
const retrieveAPI = async (currencyBill, currencyUser)=>{
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(Object.values(jsonResponse.rates)[0].rate);
            console.log(Object.values(jsonResponse.rates)[0]);
            return jsonResponse;
        }
    } catch (error) {
        console.log(error);
...
const renderCurrency = (jsonResponse)=>{
    console.log(jsonResponse.base_currency_code);
    console.log(Object.values(jsonResponse.rates)[0].constructor.name);
};
...
},{"./variables.js":"abb56","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8LrJA","ka40h"], "ka40h", "parcelRequiref673")

//# sourceMappingURL=index.af980e3f.js.map
