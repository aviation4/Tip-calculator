...
_variablesJs.inputsDOMArray.forEach((input, i)=>{
    /***** Assign Event Listener *****/ input.addEventListener("input", function() {
        ...
        /* Update results (calculate or reset) */ _functionsJs.updateResults();
        console.log(_variablesJs.inputData.tipStateArray);
    });
});

},{"./functions.js":"7pA6V","./variables.js":"1tkqv"}],"7pA6V":[function(require,module,exports) {
...
const calculateResults = ()=>{
    ...
    console.log(_variablesJs.resultTip.innerHTML);
    console.log(_variablesJs.resultTotal.innerHTML);
...
},{"./variables.js":"1tkqv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1tkqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["adtRi","1Z4Rq"], "1Z4Rq", "parcelRequiref673")
