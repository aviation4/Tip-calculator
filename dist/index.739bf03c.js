...
_variablesJs.inputsDOMArray.forEach((input, i)=>{
    /***** Assign Event Listener *****/ input.addEventListener("input", function() {
        if (i == 1) _variablesJs.inputData.tipValue = _variablesJs.inputsDOMArray[1].value;
...
},{"./variables.js":"abb56","./functions.js":"bfprH"}],"abb56":[function(require,module,exports) {
...
parcelHelpers.export(exports, "resultTipHeader", ()=>resultTipHeader
);
parcelHelpers.export(exports, "resultTipHeaderPerPerson", ()=>resultTipHeaderPerPerson
);
parcelHelpers.export(exports, "resultTotal", ()=>resultTotal
);
parcelHelpers.export(exports, "resultTotalHeader", ()=>resultTotalHeader
);
parcelHelpers.export(exports, "resultTotalHeaderPerPerson", ()=>resultTotalHeaderPerPerson
);
...
parcelHelpers.export(exports, "animatedModules", ()=>animatedModules
);
const inputData = {
...
const resultTipHeader = document.getElementById("results__tipHeader");
const resultTipHeaderPerPerson = document.getElementById("results__tipHeader--person");
const resultTotal = document.getElementById("results--total");
const resultTotalHeader = document.getElementById("results__totalHeader");
const resultTotalHeaderPerPerson = document.getElementById("results__totalHeader--person");
...
const animatedModules = document.querySelectorAll(".button--reset");
...
},{}],"bfprH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "fixResultsLayout", ()=>fixResultsLayout
);
...
const enableResetButton = ()=>{
    ...
    /* Disable animations */ _variablesJs.animatedModules.forEach((el)=>{
...
const resetFontSizes = ()=>{
    if (window.screen.width > 500) {
        _variablesJs.resultTip.style.fontSize = "34.5px";
        _variablesJs.resultTotal.style.fontSize = "34.5px";
    } else {
        _variablesJs.resultTip.style.fontSize = "28.8px";
        _variablesJs.resultTotal.style.fontSize = "28.8px";
    }
    _variablesJs.resultTipHeader.style.fontSize = "16.7px";
    _variablesJs.resultTipHeaderPerPerson.style.fontSize = "13.9px";
    _variablesJs.resultTotalHeader.style.fontSize = "16.7px";
...
const fixResultsLayout = ()=>{
    ...
    while(_variablesJs.resultTip.offsetHeight > 45 || _variablesJs.resultTipHeader.offsetHeight > 30){
        /* Defining font sizes */ resultTipFontSize = window.getComputedStyle(_variablesJs.resultTip).getPropertyValue("font-size");
        resultTipHeaderFontSize = window.getComputedStyle(_variablesJs.resultTipHeader).getPropertyValue("font-size");
        resultTipHeaderPerPersonFontSize = window.getComputedStyle(_variablesJs.resultTipHeaderPerPerson).getPropertyValue("font-size");
        /* Coverting to number */ resultTipFontSizeShort = resultTipFontSize.slice(0, resultTipFontSize.length - 2);
        ...
        /* Decreasing font size value */ resultTipFontSizeNew = resultTipFontSizeShort - 0.5 + "px";
        ...
        /* Assigning new font size values */ _variablesJs.resultTip.style.fontSize = resultTipFontSizeNew;
    ...
    while(_variablesJs.resultTotal.offsetHeight > 45 || _variablesJs.resultTotalHeader.offsetHeight > 30){
        /* Defining font sizes */ resultTotalFontSize = window.getComputedStyle(_variablesJs.resultTotal).getPropertyValue("font-size");
        resultTotalHeaderFontSize = window.getComputedStyle(_variablesJs.resultTotalHeader).getPropertyValue("font-size");
        resultTotalHeaderPerPersonFontSize = window.getComputedStyle(_variablesJs.resultTotalHeaderPerPerson).getPropertyValue("font-size");
        /* Coverting to number */ resultTotalFontSizeShort = resultTotalFontSize.slice(0, resultTotalFontSize.length - 2);
        ...
        /* Decreasing font size value */ resultTotalFontSizeNew = resultTotalFontSizeShort - 0.5 + "px";
        ...
        /* Assigning new font size values */ _variablesJs.resultTotal.style.fontSize = resultTotalFontSizeNew;
        _variablesJs.resultTotalHeader.style.fontSize = resultTotalHeaderFontSizeNew;
        _variablesJs.resultTotalHeaderPerPerson.style.fontSize = resultTotalHeaderPerPersonFontSizeNew;
    }
    ...
    _variablesJs.resultTip.style.fontSize = lowerFontSizeValue - 0.5 + "px";
    _variablesJs.resultTotal.style.fontSize = lowerFontSizeValue - 0.5 + "px";
    _variablesJs.resultTipHeader.style.fontSize = lowerHeaderFontSizeValue - 0.5 + "px";
    _variablesJs.resultTotalHeader.style.fontSize = lowerHeaderFontSizeValue - 0.5 + "px";
    _variablesJs.resultTipHeaderPerPerson.style.fontSize = lowerHeaderPerPersonFontSizeValue - 0.5 + "px";
    _variablesJs.resultTotalHeaderPerPerson.style.fontSize = lowerHeaderPerPersonFontSizeValue - 0.5 + "px";
};
const resetResults = ()=>{
    _variablesJs.resultTip.innerHTML = _variablesJs.inputData.currencySymbols[_variablesJs.inputData.currencyState] + "0";
    _variablesJs.resultTotal.innerHTML = _variablesJs.inputData.currencySymbols[_variablesJs.inputData.currencyState] + "0";
...
},{"./variables.js":"abb56","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l4AUa","ebWYT"], "ebWYT", "parcelRequiref673")
