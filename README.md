...
![button predefined](/docs/tip-percentage/tip-percentage-button-predefined.png)

or by entering custom value:

![custom value](/docs/tip-percentage/tip-percentage-custom-value.png)
